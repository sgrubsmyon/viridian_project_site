...
use of renewable energies) are rewarded with more credits by the Daemon network.
...
* [CoinSence](http://coinsence.org/) wants to create a common platform for social
  ...
  the development of a collaborative, fair, sustainable economy. Join the
  [Viridian Project community space](https://community.coinsence.org/s/viridian-project)
  on the CoinSence community platform!

There could be opportunities to cooperate with these projects and benefit from
synergies.
