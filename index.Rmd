...
We live in a world where many things just seem to be **going wrong**. Growing
...
Thus, the *Viridian Project* aims for an alternative way of **economic activity**.
...
the people using the currency. In addition, the **rules of the network shall be set by the people**
using it: in an open, collaborative process, similar to the development of open
source software. The use of computer networks allows the usage of innovative
...
**Sustainable and socially responsible business and commerce shall be incentivized**
...
and *why* they are like that, including the internalization of external
...
There are many open questions and unsolved problems. **Are you inspired by the idea of the project? You can help!**
Just pick your area of interest and start getting involved.
