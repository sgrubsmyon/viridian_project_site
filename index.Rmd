...
<img src="images/network.svg" style="height: 100px;">
...
<img src="images/like.svg" style="height: 100px;">
<img src="images/dislike.svg" style="height: 100px;">

#### Democratization

Running on decentralized nodes, economy and society become more democratic and
more equal, because concentration of resources and power can be prevented.
Cryptocurrencies enable to move power away from centralized banks and towards
the people using the currency. In addition, the rules of the network shall be
set by the people using it: in an open, collaborative process, similar to the
development of open source software. The use of computer networks allows the
usage of innovative democratic consensus tools like liquid democracy.
...
<img src="images/sprout.svg" style="height: 100px;">
...
<img src="images/handshake.svg" style="height: 100px;">
...
<img src="images/search.svg" style="height: 100px;">
...
<img src="images/lock.svg" style="height: 100px;">
...
In the Viridian economy, will banks still be important players? How shall banks
be treated? Will banks' services also have associated colors? Will banks be
superseded by innovative new concepts, e.g. peer-to-peer credit systems with
risk scattering by spreading investment money on many actors?
...
might help to prevent such situations and create a market that is closer to
Smith's ideal.
...
In Smith's ideal free market, all prices reflect the actual cost that a
product's production imposes on society. For example, if a worker needs to spend
more time on one product than on another, then it must cost more to reflect this.
If the production leads to external costs that society (ultimately everyone,
including the buyer and the seller) must pay for, then the product should also
cost more, to pay for these costs and also to regulate the demand for the product.
...
How can we create business models that would make the adoption of Viridian
lucrative for businesses, e.g. through improved image or intensified customer
relations?
...
Law can be very unintuitive and incomprehensible for laymen. Maybe there is an
obvious legal obstacle that did not occur to us yet?
...
way? Or do you think audits are actually a bad thing and there are better
alternatives, e.g. using social networks and personal contacts to people?
...
hypothesis is that while conventional money stimulates mainly the rational part
of the brain, there could also be a component of money that stimulates the
emotional part. With the emotional component putting an emphasis on empathy and
...
Capitalist advertising makes use of all kind of psychological tricks to entice
people and encourage them to change their behavior (mostly to buy stuff they
don't really need).

What kind of psychological tricks could be used to convince people to use the
ethical Vidirian money? Could peer-pressure be used in a positive way to attract
new users? Maybe in the lines of "Three of your friends already use Viridian,
when do you come and join us?"
...
Therefore, it is very important to implement sustainable development in a way
that improves the socio-economic status of the vast majority of people and
especially the poorest. The rich are the biggest polluters, so they are also
the ones that should pay for the transition towards a safe world.
...
technology may allow better alternatives to this paradigm.
...
There are already many good concepts of sustainable economy, e.g.:
...
The Viridian project does not have complete solutions on these three points
either, yet. But we have a vision. And you can help us turn that vision into a
