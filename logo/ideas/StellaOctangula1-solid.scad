// source=coordinates form=solid id =StellaOctangula1
solid_1 = StellaOctangula1();
p_describe(solid_1);
scale(20) show_solid(solid_1);

function Z() = StellaOctangula1();
function StellaOctangula1() = 
// source:  http://dmccooey.com/polyhedra/StellaOctangula1.txt
// generated by  http://kitwallace.co.uk/3d/solid-index.xq
let(C0 = 0.353553390593273762200422181052)
poly(name = "Stella Octangula",
// 3 sided faces = 8
vertices = [
[ C0,  C0,  C0],
[ C0,  C0, -C0],
