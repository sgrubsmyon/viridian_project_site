...
Ziel ist es, ein Computernetz für Wirtschaftstransaktionen zu schaffen, das die
folgenden Vorteile mit sich bringt:
...
Dank Dezentralisierung werden Wirtschaft und Gesellschaft
...
Transparente Preismechanismen **setzen Anreize** für ein nachhaltiges und sozial
...
Es muss **jederzeit sichtbar sein, wie die Regeln des Netzwerks sind**
...
Die Mechanik des Netzwerks muss jederzeit transparent sein, einschließlich der
Internalisierung externer Kosten. Änderungen an den Algorithmen oder einer Bewertung
müssen von legitimierenden Informationen begleitet werden.
